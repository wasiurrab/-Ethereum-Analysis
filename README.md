...
Dataset Schema - transactions block_number: Block number where this transaction was in
...
Dataset Schema - contracts address: Address of the contract
...
Analysis Performed-- Part A -Time Analysis Part B -Top Ten Most Popular Services Part C - Top Ten Most Active Miners Part D - Data exploration
